...
SECRET_KEY = 'a17m*2qlg@q!)=#(h^on$1*#-tfby+dfl1+&6v@6@#gbtc18bj'
...
# 通过django-redis操作redis，获取redis连接对象
...
CRONJOBS = [
    # 每5分钟执行一次生成主页静态文件
    ('* * * * *', 'contents.crons.generate_static_index_html', '>>'+ os.path.dirname(BASE_DIR)+'/logs/crontab.log')
]
# 解决crontab定时任务中文问题
